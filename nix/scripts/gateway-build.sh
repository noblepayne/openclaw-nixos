...
# Run postbuild but skip the network-heavy runtime dependency staging.
# We already have all dependencies in the main node_modules.
log_step "build: runtime-postbuild" env OPENCLAW_SKIP_BUNDLED_PLUGIN_RUNTIME_STAGING=1 node scripts/runtime-postbuild.mjs
...
log_step "build: stage-bundled-plugin-runtime" node "$STAGE_BUNDLED_PLUGIN_RUNTIME_DEPS_WRAPPER_MJS"
